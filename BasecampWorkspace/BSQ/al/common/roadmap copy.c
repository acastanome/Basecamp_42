...
int		ft_start_world_engine(t_map map) //will go through process with each map. put this inside Milans main while arv[i] !=\0
{
	map.grid = creategrid(map, WHAT_HERE); //step 3
	return (0);
}
