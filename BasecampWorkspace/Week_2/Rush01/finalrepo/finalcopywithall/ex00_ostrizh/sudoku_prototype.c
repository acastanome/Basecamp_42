...
/* solve sudoku */
{
	...
	if (row == 9 - 1 && col == 9) // condition for ending recursion from loop(line 136),
		return (1);// when we went through the whole array to its end
	...
	if (grid[row][col] != '.') 
        return solver(grid, row, col + 1); // if not empty just go to next element
...
// ".136578.." "8.5319.64" "967.2..3." "594...3.." "7.2...6.1" "186..3592" "671...4.." "..9...2.6" "...53.9.."
